...
RoutingProxy.prototype.add = function (options) {
  ...
  //add by fish
  options.target.addPathHead = options.addPathHead;
  options.target.replaceObj = options.replaceObj;
  options.replaceRelativePath = this.replaceRelativePath;
  //added
...
RoutingProxy.prototype.proxyRequest = function (req, res, options) {
  ...
  if (this.proxyTable && !options.host) {
	...
	//add by fish
	options.addPathHead = location.addPathHead;
	options.replaceObj = location.replaceObj;
	//added
  }
